    ...
    public void startUp() {
        ...
        ActionListener startListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (aPort.equals("")) {
                    JOptionPane.showMessageDialog(serverFrame, "Please enter right port!");
                } else {
                    try {
                        // 等待客户端连接的线程
                        Runnable serverRunnable = new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    serverTextArea.append("Waiting to connect...\n");
                                    while (true) {
                                        Socket clientSocket = serverSocket.accept();
                                        serverTextArea.append("The Client is connected...\n");
        ...
        ActionListener SayListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!aText.equals("")) {
                    ...
                    JOptionPane.showMessageDialog(serverFrame, "the content can not be blank!");
                }
            }
        };
